...
import { RiDeleteBin7Fill } from "react-icons/ri";//03:19:22
/*
echo "# saaspf" >> README.md
git init
git add .
git commit -m "first commit"
git branch -M main
git remote add origin git@github.com:Chaitany3031/saaspf.git
                        ...
                        <tr key={blog._id}>
                            ...
                            <td>
                              <div className="flex gap-2 flex-center">
                                ...
                                <Link href={'/projects/delete/'+blog._id}><button><RiDeleteBin7Fill /></button></Link>
                              </div>
                            </td>
                        </tr>
                    ))
